...
bool OBSBasic::InitBasicConfigDefaults()
{
	...
	config_set_default_uint  (basicConfig, "AdvOut", "VBitrate", 2500);
	config_set_default_bool  (basicConfig, "AdvOut", "UseBufsize", false);
	config_set_default_uint  (basicConfig, "AdvOut", "Bufsize", 2500);
	...
	config_set_default_bool  (basicConfig, "AdvOut", "UseCBR", true);
	config_set_default_string(basicConfig, "AdvOut", "Preset", "veryfast");
	...
	config_set_default_string(basicConfig, "AdvOut", "RecFilePath",
			GetDefaultVideoSavePath().c_str());
	config_set_default_bool  (basicConfig, "AdvOut", "RecCopyStream",
			true);
	config_set_default_uint  (basicConfig, "AdvOut", "RecVBitrate", 2500);
	config_set_default_bool  (basicConfig, "AdvOut", "RecUseBufsize",
			false);
	config_set_default_uint  (basicConfig, "AdvOut", "RecBufsize", 2500);
	config_set_default_bool  (basicConfig, "AdvOut", "RecUseCBR", true);
	config_set_default_string(basicConfig, "AdvOut", "RecPreset",
			"veryfast");
